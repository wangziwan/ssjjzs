...
<script>
	...
	export default {
		...
		mounted(){
			...
			//加载资讯内容
			getData('GET','https://www.easy-mock.com/mock/5a68269de91af545282b6be8/example/detail/'+this.$route.params.id+'/content')
			.then((response)=>{
			...
			//加载评论
			getData('POST','https://www.easy-mock.com/mock/5a68269de91af545282b6be8/example/detail/'+this.$route.params.id+'/comment')
			.then((response)=>{
				console.log(response.data.data)
